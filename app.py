...
with dash_1:
    st.markdown("<h2 style='text-align: center;'>Superstore Sales Dashboard<br><span style='font-size: 16px; color: grey;'>Created by Charishma</span></h2>", unsafe_allow_html=True)
    st.write("")
